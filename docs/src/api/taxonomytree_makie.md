...
`PaleobiologyDB.PBDBMakie` submodule explicitly.

See the [PBDBMakie guide](../guide/taxonomytree_makie.md) for installation
...
[PBDBMakie guide](../guide/taxonomytree_makie.md).
...
See the [PBDBMakie guide](../guide/taxonomytree_makie.md) for usage examples.
