...
const _PHYLOPIC_BASE_COLUMNS         = PaleobiologyDB.PhyloPicPBDB._PHYLOPIC_BASE_COLUMNS
const _PHYLOPIC_IMAGE_LIST_COLUMNS   = PaleobiologyDB.PhyloPicPBDB._PHYLOPIC_IMAGE_LIST_COLUMNS
const _phylopic_null_record_fn       = PaleobiologyDB.PhyloPicPBDB._phylopic_null_record
const _apply_prefix_fn               = PaleobiologyDB.PhyloPicPBDB._apply_fieldname_prefix
const _cc_label_fn                   = PaleobiologyDB.PhyloPicPBDB._cc_license_label
const _PHYLOPIC_BUILD_REF            = PaleobiologyDB.PhyloPicPBDB._PHYLOPIC_BUILD
