...
# ---------------------------------------------------------------------------
# PhyloPicDB.PhyloPicMakie — thumbnail grid rendering
#
...
# taxon names → images) lives in PaleobiologyDB.PhyloPicPBDB, which calls
# phylopic_thumbnail_grid! after building the cell arrays.
#
